        ...
        public void sendMessage()
        {
            ...
            if (message.Length > 0)
            {
                ...
                if (message[0] == '/')
                {
                    ...
                    else if (needCommand.ToLower() == "disconnect") packet = Protocol.ConfigurePacket(Command.UTILS, Settings.name, "disconnect", Encoding.Unicode.GetBytes(needData)); // Configure desconnect comamnd
