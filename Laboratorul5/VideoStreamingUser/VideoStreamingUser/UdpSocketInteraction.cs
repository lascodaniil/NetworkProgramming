    ...
    public class UdpSocketInteraction
    {
        ...
        public byte[] GetByteArrayDataFromUdpSocket()
        {
            ...
            do
            {
                ...
                int image_id = BitConverter.ToInt32(reciveData, 0); 
                int current_package_id = BitConverter.ToInt32(reciveData, 4); 
                ...
                if (allPackages.ContainsKey(image_id))
                {
                    PackagesControler currentPackageControler = allPackages[image_id];
                ...
                else
                {
                    ...
                    allPackages[image_id] = currentPackageControler;
                }
            }
